...
<body>
    <?php
        ...
        try {
            ...
            $cadastro = "INSERT INTO tblnivelacesso(nivelacesso,criadoem,modificadoem) VALUES (:nivelacesso,:criadoem,:modificadoem)";
            ...
            $cadastrar->bindParam(':nivelacesso',$nivelacesso, PDO::PARAM_STR);
